...
public class PSTFileMetaTest {
	...
	public void testUpdateSizeStatistics() {
		double sizes[] = { 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 100,
				200, 300, 400, 500, 600, 700, 800, 900, 1000, 100, 200, 300,
		...
		Assert.assertEquals(5500, Math.round(metaData.getAverageAttachmentSize()));
		Assert.assertEquals(550, Math.round(metaData.getCompressedAverageAttachmentSize()));
		...
		Assert.assertEquals(5500, Math.round(metaData.getMedianAttachmentSize()));
		Assert.assertEquals(550, Math.round(metaData.getMedianCompressedAttachmentSize()));
