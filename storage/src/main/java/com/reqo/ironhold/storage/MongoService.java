...
public class MongoService implements IStorageService {
	...
	public void markAsIndexed(String messageId) throws JsonParseException,
	...
	public void update(MailMessage mailMessage) throws JsonGenerationException,
		...
		db.getCollection(MESSAGE_COLLECTION).update(query,
	...
	public MailMessage getMailMessage(String messageId,
		...
		if (!includeAttachments) {
			DBObject fields = BasicDBObjectBuilder.start().add("body", 1)
					.add("cc", 1).add("from", 1).add("messageId", 1)
