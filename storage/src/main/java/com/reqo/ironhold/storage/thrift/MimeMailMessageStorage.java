...
public class MimeMailMessageStorage {
  ...
  public interface Iface {
    ...
    public long store(String clientName, String partition, String messageId, String message, String checkSum) throws org.apache.thrift.TException;

    public boolean exists(String clientName, String partition, String messageId) throws org.apache.thrift.TException;

    public String get(String clientName, String partition, String messageId) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void store(String clientName, String partition, String messageId, String message, String checkSum, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.store_call> resultHandler) throws org.apache.thrift.TException;

    public void exists(String clientName, String partition, String messageId, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.exists_call> resultHandler) throws org.apache.thrift.TException;

    public void get(String clientName, String partition, String messageId, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.get_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public long store(String clientName, String partition, String messageId, String message, String checkSum) throws org.apache.thrift.TException
    {
      send_store(clientName, partition, messageId, message, checkSum);
      return recv_store();
    }

    public void send_store(String clientName, String partition, String messageId, String message, String checkSum) throws org.apache.thrift.TException
    {
    ...
    public boolean exists(String clientName, String partition, String messageId) throws org.apache.thrift.TException
    {
      send_exists(clientName, partition, messageId);
      return recv_exists();
    }

    public void send_exists(String clientName, String partition, String messageId) throws org.apache.thrift.TException
    {
    ...
    public String get(String clientName, String partition, String messageId) throws org.apache.thrift.TException
    {
      send_get(clientName, partition, messageId);
      return recv_get();
    }

    public void send_get(String clientName, String partition, String messageId) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void store(String clientName, String partition, String messageId, String message, String checkSum, org.apache.thrift.async.AsyncMethodCallback<store_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      store_call method_call = new store_call(clientName, partition, messageId, message, checkSum, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public void exists(String clientName, String partition, String messageId, org.apache.thrift.async.AsyncMethodCallback<exists_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      exists_call method_call = new exists_call(clientName, partition, messageId, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public void get(String clientName, String partition, String messageId, org.apache.thrift.async.AsyncMethodCallback<get_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      get_call method_call = new get_call(clientName, partition, messageId, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class store<I extends Iface> extends org.apache.thrift.ProcessFunction<I, store_args> {
      ...
      public store_result getResult(I iface, store_args args) throws org.apache.thrift.TException {
        store_result result = new store_result();
        result.success = iface.store(args.clientName, args.partition, args.messageId, args.message, args.checkSum);
    ...
    public static class exists<I extends Iface> extends org.apache.thrift.ProcessFunction<I, exists_args> {
      ...
      public exists_result getResult(I iface, exists_args args) throws org.apache.thrift.TException {
        exists_result result = new exists_result();
        result.success = iface.exists(args.clientName, args.partition, args.messageId);
        result.setSuccessIsSet(true);
        return result;
      }
    }
    ...
    public static class get<I extends Iface> extends org.apache.thrift.ProcessFunction<I, get_args> {
      ...
      public get_result getResult(I iface, get_args args) throws org.apache.thrift.TException {
        get_result result = new get_result();
        result.success = iface.get(args.clientName, args.partition, args.messageId);
        return result;
      }
    }
  ...
  public static class store_args implements org.apache.thrift.TBase<store_args, store_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private static final org.apache.thrift.protocol.TField CHECK_SUM_FIELD_DESC = new org.apache.thrift.protocol.TField("checkSum", org.apache.thrift.protocol.TType.STRING, (short)5);
