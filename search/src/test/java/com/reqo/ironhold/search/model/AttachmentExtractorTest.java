...
public class AttachmentExtractorTest {
	...
	public void testExtractWordsFromWordAttachment() throws Exception {
		...
		String parsedContent = indexedMailMessage.getAttachments()[0].getBody().replaceAll("[ \\t\\n\\r]+", " ");
	...
	public void testExtractWordsFromPDFAttachment() throws Exception {
		...
		String parsedContent1 = indexedMailMessage.getAttachments()[0].getBody().replaceAll("[ \\t\\n\\r]+", " ");

		
        String assertContent1 = FileUtils.readFileToString(assertFile1).replaceAll("[ \\t\\n\\r]+", " ");
	...
	public void testExtractWordsFromPSTAttachment() throws Exception {
		...
		IndexedMailMessage indexedMailMessage = new IndexedMailMessage(pstMessage);
