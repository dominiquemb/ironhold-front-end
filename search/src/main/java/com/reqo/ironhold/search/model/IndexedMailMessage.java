...
public class IndexedMailMessage {
    ...
    private void load(ArchivedPSTMessage pstMessage) {
        ...
        sender = new Recipient(pstMessage.getSenderName(), pstMessage.getSenderEmailAddress());
    ...
    public static String toJSON(IndexedMailMessage message) throws JsonGenerationException, JsonMappingException,
            IOException {
        return mapper.writeValueAsString(message);
    }

    public static IndexedMailMessage fromJSON(String json) throws JsonParseException, JsonMappingException,
            IOException {
