...
public class PSTImporter {
    ...
    public void processMessages(File file, String clientName) throws Exception {
        ...
        LogMessage startedMessage = new LogMessage(LogLevel.Success, file.toString(),
                "Started pst import: File: [" + file.toString() + "] File size: [" + fileSizeDisplay + "]");
        ...
        String timeTook = DurationFormatUtils.formatDurationWords(finished - started, true, true);
    ...
    private void processFolder(String folderPath, PSTFolder folder) throws Exception {
        LogMessage folderMessage = new LogMessage(LogLevel.Success, file.toString(),
                "Processing " + folderPath + " [" + folder.getContentCount() + " items]");
        ...
        if (folder.getContentCount() > 0) {
            ...
            while (message != null) {
                ...
                PSTMessageSource source = new PSTMessageSource(file.toString(), folderPath, file.length(),
                ...
                LogMessage processedMessage = new LogMessage(LogLevel.Success, messageId, "Processed pst message");
